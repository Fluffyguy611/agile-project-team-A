...
public class JobRoleValidatorTest {
    ...
    public void WhenJobRoleNameOver64CharactersExpectErrorMessage() {
        JobRoleRequest jobRoleRequest = new JobRoleRequest("123451234512345123451234512345123412345123451234512345123451234512341234512345123451234512345123451234", "Manages stuff", "Some SP Link", 1);
